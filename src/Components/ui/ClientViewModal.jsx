...
export default function ClientViewModal({isOpen, onClose, data}) {
  
    const [showEmailOptions, setShowEmailOptions] = useState(false)
    const lastContactedAt = (new Date(data.lastContactedAt)).toString()
                    ...
                    <div className="flex min-h-full items-center justify-center p-8"> 
                        ...
                        >                        
                            <DialogPanel className='bg-white rounded-xl shadow-lg p-12 relative w-full max-w-2xl' >
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] items-start p-4 text-xl rounded-xl group gap-4"> 
                                    <p className="font-semibold text-gray-900 mr-3"> Last Contacted: </p>                                                                   
                                    <p className="text-gray-600 leading-relaxed">                            
                                         {(data.lastContactedAt && data.lastContactedAt !== "0001-01-01T00:00:00")
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-[120px_1fr] items-start p-4 text-xl rounded-xl group gap-4"> 
                                    <p className="font-semibold text-gray-900 mr-3"> Converted: </p>                                                                   
                                    <p className="text-gray-600 leading-relaxed">                            
                                        {data.isConverted ? "Yes" : "No"}
                                    </p>
                                </div>
                                ...
                                <div className="mt-10 border-t pt-8 text-center">
                                    <p className="text-base font-medium text-gray-700 mb-6">
                                        Add notes or follow-up details for this client
                                    </p>
